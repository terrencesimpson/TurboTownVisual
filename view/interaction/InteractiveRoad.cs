...
{
    public class InteractiveRoad : MonoBehaviour
    {
        ...
        void OnMouseDown()
        {
            ...
            if (EventSystem.current.IsPointerOverGameObject() || 
                RayCastUtility.IsPointerOverUIObject() || 
                _buildingManager.buildingMovingState || 
                _buildingManager.buildingForPurchaseState || 
                (BuildingUtilityDelegate.isRoadOrBridge() && JobFactory.buildingManager.buildingForPurchaseState))
            {
                return;
            }
        ...
        void Update()
        {
            if (BuildingUtilityDelegate.isRoadOrBridge() && JobFactory.buildingManager.buildingForPurchaseState && _buildingManager.mouseDown)
            {
